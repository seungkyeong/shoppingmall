...
<div style="float: left; width: 45%; padding:10px;">
	...
	<input type="submit" value="장바구니" formation="cart.jsp" style="border-radius:0 0 0 0; background-color:white; border-color:#ffadaf; color: #f75c74; outline: 0; width:100px; height: 40px;">
	<input type="submit" value="바로구매" formation="rightawaybuy.jsp" style="border-radius:0 0 0 0; background-color::#ffadaf; border-color: #ffadaf; color: white; box-shadow: 0; width:100px; height: 40px;">
</div> 
